package CompareSortingAlgorithms;

import java.util.Arrays;
import java.util.Random;

/*
this Program is comparing the sorting algorithms (Quick sort, Merge sort and Heap sort)
 */
...
//		System.exit(1);
		...
		CompareSortingAlgorithms.quickSort(arr, 0, arr.length - 1);
		...
		for (int i = 1; i <= 13; i++) {
			...
			if (size> 262144){
				...
				start_time = System.nanoTime();
				CompareSortingAlgorithms.quickSort(arr2, 0, arr2.length - 1);
				 end_time = System.nanoTime();
