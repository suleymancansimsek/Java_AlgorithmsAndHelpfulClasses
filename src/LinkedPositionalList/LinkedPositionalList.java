...
public class LinkedPositionalList<E> implements PositionalList<E> {
  ...
  public int indexOf(Position<E> p) {
    ...
    int count = 0;
    // initialize a Position object called walk and initialize it to the output of the first() method
    Position<E> walk = first();
    // continue iterating as long as walk is not equal to p
    while (walk != p) {
      // increase count variable by 1
      count++;
      // advance walk to the next position by calling the after() method
      walk = after(walk);
    }
  ...
  public Position<E> findPosition(E e) {
    // initialize a Position object called walk and initialize it to the output of the first() method
    Position<E> walk = first();
    // continue iterating as long as walk is not null and the element at position walk is not equal to e
